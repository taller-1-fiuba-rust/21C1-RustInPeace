...
fn test_main() {
    ...
    let added_item_list_22 = ValueTimeItem::new_now(
        ValueType::ListType(vec![
            "my".to_string(),
            "dog".to_string(),
            "my".to_string(),
    ...
    database.add(String::from("love_the_dog"), added_item_list_22);

    let added_item_list_23 = ValueTimeItem::new_now(
        ValueType::ListType(vec![
            "my".to_string(),
            "cat".to_string(),
            "my".to_string(),
    ...
    database.add(String::from("love_the_cat"), added_item_list_23);

    let added_item_list_24 = ValueTimeItem::new_now(
        ValueType::ListType(vec![
            "my".to_string(),
            "bunny".to_string(),
            "my".to_string(),
    ...
    database.add(String::from("love_the_bunny"), added_item_list_24);
